...
// forge script scripts/FraxtalHub/4_SendFraxOFTFraxtalHub/SendFraxOFTSomniaToFraxtal.s.sol --rpc-url https://api.infra.mainnet.somnia.network --broadcast

contract SendFraxOFTSomniaToFraxtal is SendFraxOFTFraxtalHub {
    constructor() {
