...
export const chains: Record<string, ChainInfo> = {
    ...
    base: {
        ...
        fraxProxyAdmin: "0xF59C41A57AB4565AF7424F64981523DfD7A453c5"
    },
    blast: {
        client: createPublicClient({
            chain: blast,
    ...
    zksync: {
        ...
        fraxProxyAdmin: "0xe59dcae52a4ffa39be99588486c84bc2dc1ba52f"
    },
    abstract: {
        client: createPublicClient({
            chain: abstract,
    ...
    linea: {
        ...
        fraxProxyAdmin: "0x3cf371c128b092b085B7732069cEAF3Fd863F270"
    },
    aurora: {
        client: createPublicClient({
            chain: aurora,
    ...
    scroll: {
        ...
        fraxProxyAdmin: "0x8f1b9c1fd67136d525e14d96efb3887a33f16250"
    },
    unichain: {
        client: createPublicClient({
            chain: unichain,
